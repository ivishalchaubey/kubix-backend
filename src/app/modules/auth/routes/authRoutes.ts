...
router.patch(
  "/user-course-payment-status",
  AuthMiddleware.authenticate,
  authValidation.updateUserCoursePaymentStatus,
  authController.updateUserCoursePaymentStatus
);
...
router.get(
  "/tokens/balance",
  AuthMiddleware.authenticate,
  UserTokenController.getUserTokenBalance
);
router.post(
  "/tokens/spend",
  AuthMiddleware.authenticate,
  UserTokenController.spendTokens
);
router.get(
  "/tokens/history",
  AuthMiddleware.authenticate,
  UserTokenController.getTokenHistory
);

...
adminRouter.get("/user/categories",AuthMiddleware.authenticate, asyncHandler((req : Request, res : Response, next : NextFunction) => adminController.getUserCategories(req, res, next)));


adminRouter.post("/categories/upload-csv", upload.single('csvFile'), asyncHandler((req : Request, res : Response, next : NextFunction) => adminController.uploadCategoriesFromCSV(req, res, next)));
